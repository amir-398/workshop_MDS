    ...
    <form onSubmit={handleSubmit(onSubmitForm)} className='space-y-6 max-w-sm mx-auto mb-12'>
        ...
        <div>
            ...
            <input
                id="price"
                type="number"
                {...register("price", { required: "Vous devez renseigner le prix de la console", min: 0 })}
                className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            />
        ...
        <div>
            <label htmlFor="discountPrice" className="block text-sm font-medium text-gray-900">Prix remisé</label>
            <input
                id="discountPrice"
                type="number"
        ...
        {/* Submit button */}
        <button type="submit" className="bg-black hover:bg-[#2a74ed] transition duration-300 text-white px-4 py-2 rounded w-full">
            Enregistrer
        </button>
    </form>
  )
