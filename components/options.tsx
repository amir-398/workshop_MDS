...
const Options = ({ consoleId }: OptionsProps) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center h-screen relative ">
      ...
      <div className="flex-1 p-4 relative max-w-full lg:max-w-[50%] mx-auto">
        ...
        {selectedRearShell && (
          <Image
            ...
            width={800}
            height={600}
            className="absolute -top-1 left-0 w-full h-auto scale-95"
          />
        )}
        ...
        {selectedIpsScreen && (
          <Image
            ...
            width={800}
            height={600}
            className="absolute -top-1 md:-top-2 left-0 w-full h-auto scale-95"
          />
        )}
        ...
        {selectedButton && (
          <Image
            ...
            width={800}
            height={600}
            className="absolute top-[-7px] left-0 md:left-0  w-full h-auto scale-95"
          />
        )}
      ...
      <div className="flex-1 h-[80vh] bg-white p-6 lg:mx-60 my-8 w-full md:w-[60vw] rounded-lg shadow-2xl top-0 left-10 ">
        ...
        <div className="overflow-y-auto overflow-hidden h-5/6">
        ...
        <button
          className="mt-4 bg-blue-500 text-white h-11 px-4 rounded w-full bg-gradient-to-r from-teal-400 to-blue-500 hover:from-pink-500 hover:to-orange-500"
          onClick={onSubmit}
